...
def stratified_sampling_probability(data, sample_size_dict, estimated_frequency, group_by_attributes):
    """
    基于概率的分层采样
    """
    n = len(data)
    group_counts = {key: n * freq for key, freq in estimated_frequency.items()}
